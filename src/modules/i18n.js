...
const PHRASES = {
  ...
  // 集水區 master switch
  '啟用集水區': { en: 'Enable catchment', ja: '集水域を有効化', ko: '집수 구역 사용', fr: 'Activer le bassin versant', de: 'Einzugsgebiet aktivieren', es: 'Activar cuenca', it: 'Attiva bacino' },
  '關閉後，量測工具、下方面板、3D 圖層與資訊卡的集水區功能都會鎖定': { en: 'When off, catchment is locked in the measure tool, bottom panel, 3D layer and info cards', ja: 'オフにすると、計測ツール・下部パネル・3Dレイヤー・情報カードの集水域機能がロックされます', ko: '끄면 측정 도구, 하단 패널, 3D 레이어, 정보 카드의 집수 구역 기능이 잠깁니다', fr: 'Désactivé : le bassin versant est verrouillé dans l’outil de mesure, le panneau inférieur, la couche 3D et les fiches d’info', de: 'Aus: Einzugsgebiet ist im Messwerkzeug, im unteren Panel, in der 3D-Ebene und in den Infokarten gesperrt', es: 'Si se desactiva, la cuenca queda bloqueada en la herramienta de medición, el panel inferior, la capa 3D y las tarjetas de info', it: 'Se disattivato, il bacino è bloccato in strumento di misura, pannello inferiore, livello 3D e schede info' },
  ...
  '正在載入集水區資訊': { en: 'Loading catchment info', ja: '集水域情報を読み込み中', ko: '집수 구역 정보를 불러오는 중', fr: 'Chargement des infos du bassin versant', de: 'Einzugsgebietsdaten werden geladen', es: 'Cargando información de la cuenca', it: 'Caricamento info bacino' },
