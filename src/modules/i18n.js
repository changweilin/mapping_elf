...
const PHRASES = {
  ...
  '主航點資訊': { en: 'Main waypoint info', ja: '主要ウェイポイント情報', ko: '주요 웨이포인트 정보', fr: 'Infos waypoint principal', de: 'Hauptwegpunkt-Infos', es: 'Info de waypoint principal', it: 'Info waypoint principale' },
  '副航點資訊': { en: 'Secondary waypoint info', ja: '副ウェイポイント情報', ko: '보조 웨이포인트 정보', fr: 'Infos waypoint secondaire', de: 'Neben-Wegpunkt-Infos', es: 'Info de waypoint secundario', it: 'Info waypoint secondario' },
