...
export class MapManager {
  ...
  fitToRoute() {
    ...
    const bottomPanelEl = document.getElementById('bottom-panel') || document.querySelector('.bottom-panel');
    const bottomPad = bottomPanelEl ? bottomPanelEl.offsetHeight + 20 : 50;
    const fitOpts = {
      paddingTopLeft: [50, 50],
      paddingBottomRight: [bottomPad, rightPad],
    };
